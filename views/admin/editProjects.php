...
<html lang="ru">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <h2 class="content__title">Бағдарламалар беті</h2>
          <div class="form-wrap">
            <form method="post" class="content__form" enctype="multipart/form-data">
                <div class="form__item">
                  ...
                  <input require type="text" name="title" id="title" class="form__input" placeholder="Тақырыпты жазыңыз" value="<?php echo $projectsItem['title'] ?>" />
                </div>
                <div class="form__item--textarea">
                  <label for="img" class="form__label">Мәтін</label>
                  <textarea require name="text" id="text" cols="30" rows="10" class="form__textarea" placeholder="Мәтінді теріңіз..."><?php echo $projectsItem['text_short'] ?></textarea>
                </div>
