          ...
          <div class="form-wrap">
            <form method="post" class="content__form" enctype="multipart/form-data">
                <div class="form__item">
                  ...
                  <input require type="text" name="title" id="title" class="form__input" placeholder="Тақырыпты жазыңыз" />
                </div>
                <div class="form__item">
                  <label for="img" class="form__label">Обложка(Бар болса)</label>
                  <input type="file" name="img" id="img" value=""/>
                </div>
                <div class="form__item--textarea">
                  <label for="img" class="form__label">Мәтін</label>
                  <textarea require name="text" id="text" cols="30" rows="10" class="form__textarea" placeholder="Мәтінді теріңіз..."></textarea>
                </div>
